...
public class CircleIndicator extends View {
    ...
    public CircleIndicator(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        normalRadius = a.getDimension(R.styleable.CircleIndicator_normalRadius, normalRadius);
        selectedRadius = a.getDimension(R.styleable.CircleIndicator_selectedRadius, selectedRadius);
        normalRadiusColor = a.getColor(R.styleable.CircleIndicator_normalRadiusColor, normalRadiusColor);
        selectedRadiusColor = a.getColor(R.styleable.CircleIndicator_selectedRadiusColor, selectedRadiusColor);
        dotPadding = a.getDimension(R.styleable.CircleIndicator_dotPadding, dotPadding);
        isStroke = a.getBoolean(R.styleable.CircleIndicator_isStroke, isStroke);
        normalStrokeWidth = a.getDimension(R.styleable.CircleIndicator_normalStrokeWidth, normalStrokeWidth);
        isBlink = a.getBoolean(R.styleable.CircleIndicator_isBlink, isBlink);
        a.recycle();
