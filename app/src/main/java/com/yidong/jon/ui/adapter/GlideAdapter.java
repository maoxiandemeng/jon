...
public class GlideAdapter extends RecyclerView.Adapter<GlideAdapter.ViewHolder> {
    ...
    public GlideAdapter(Context context, ArrayList<Type> dataSet) {
        mContext = context;
        mDataSet = dataSet;
    }
    ...
    @Override public void onBindViewHolder(GlideAdapter.ViewHolder holder, int position) {
        switch (mDataSet.get(position)) {
            case Mask: {
                int width = Helpers.dpToPx(133.33f, mContext);
                int height = Helpers.dpToPx(126.33f, mContext);
                Glide.with(mContext)
                        .load(R.drawable.guide_home_on)
            ...
            case NinePatchMask: {
                int width = Helpers.dpToPx(150.0f, mContext);
                int height = Helpers.dpToPx(100.0f, mContext);
                Glide.with(mContext)
